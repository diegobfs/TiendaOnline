...
<html>
	<head>
		<title>SHISHA PRIME-El Nefes</title>
		<style>	
	...
	<body>
		...
		<div class="contenedor">
				...
				<ul id="menu">
					...
					<li><a href="..\Biblioteca.jsp">Biblioteca</a>
						<ul>
							...
							<li><a href="El Nefes.jsp"><strong>El Nefes</strong></a></li>
			...
			<h2>Cachimbas El Nefes</h2>

			<div class="cuerpo">
				<p> El Nefes es una empresa turca caracterizada por la decoración a mano con los mejores materiales del mercado. Muchas de ellas están equipadas con base de bohemia y latón.</p>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\El Nefes 1.jpg">
   						<img src="..\Images\El Nefes 1.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">El nefes colonial ambar</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\El Nefes 2.jpg">
   						<img src="..\Images\El Nefes 2.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">El nefes sultan clear</div>
				</div>
			</div>
			...
			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\El Nefes 3.jpg">
   						<img src="..\Images\El Nefes 3.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">El nefes drill</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\El Nefes 4.jpg">
   						<img src="..\Images\El Nefes 4.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">El nefes sultan led mini</div>
				</div>
			</div>
