...
<html>
	<head>
		<title>SHISHA PRIME-Dud Boost</title>
	<style>	
	...
	<body>
		...
		<div class="contenedor">
				...
				<ul id="menu">
					...
					<li><a href="..\Biblioteca.jsp">Biblioteca</a>
						<ul>
							...
							<li><a href="Dud Boost.jsp"><strong>Dud Boost</strong></a></li>
			...
			<h2>Cachimbas Dud Boost</h2>

			<div class="cuerpo">
				<p> Dud Boost es una empresa holandesa caracterizada por sacar al mercado una amplia diversidad de diseños, tamaños y colores de cachimbas. Además destaca por su estética, rendimiento y la calidad-precio.</p>	
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Dud Boost1.jpg">
   						<img src="..\Images\Dud Boost1.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Boost-Dud edición 50</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Dud Boost2.jpg">
   						<img src="..\Images\Dud Boost2.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Dud temple red</div>
				</div>
			</div>
			...
			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Dud Boost3.jpg">
   						<img src="..\Images\Dud Boost3.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Dud new viper blue</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Dud Boost4.jpg">
   						<img src="..\Images\Dud Boost4.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Boost red lava marble</div>
				</div>
			</div>
