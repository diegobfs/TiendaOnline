...
<html>
	<head>
		<title>SHISHA PRIME-StarBuzz</title>
		<style>	
	...
	<body>
		...
		<div class="contenedor">
				...
				<ul id="menu">
					...
					<li><a href="..\Biblioteca.jsp">Biblioteca</a>
						<ul>
							...
							<li><a href="StarBuzz.jsp"><strong>StarBuzz</strong></a></li>
			...
			<h2>Cachimbas StarBuzz</h2>

			<div class="cuerpo">
				<p> Star Buzz es una empresa estado unidense caracterizada por el uso de colores vivos y sus diferentes formas.</p>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\StarBuzz 1.jpg">
   						<img src="..\Images\StarBuzz 1.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Starbuzz Unicus 2.0 Azul</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\StarBuzz 2.jpg">
   						<img src="..\Images\StarBuzz 2.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">StarBuzz Carbine black black</div>
				</div>
			</div>
			...
			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\StarBuzz 3.jpg">
   						<img src="..\Images\StarBuzz 3.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">StarBuzz Phoenix jr verde</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\StarBuzz 4.jpg">
   						<img src="..\Images\StarBuzz 4.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Starbuzz Carbine 2.0 white gold</div>
				</div>
			</div>
