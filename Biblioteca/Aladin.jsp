...
<html>
	<head>
		<title>SHISHA PRIME-Aladín</title>
		<style>	
			header{
				text-align: center;
			}
	...
	<body>
		...
		<div class="contenedor">
			...
			<div class="navegador">
				<ul id="menu">
					...
					<li><a href="..\Biblioteca.jsp">Biblioteca</a>
						<ul>
							<li><a href="Aladin.jsp"><strong>Aladín</strong></a></li>
			...
			<h2>Cachimbas Aladín</h2>

			<div class="cuerpo">
				<div class="texto">
					<p>Aladín es una marca alemana, caracterizada por el uso de aluminio desde sus comienzos en este producto, usando siempre un estilo tradicional.</p>	
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Aladin 1.jpg">
   						<img src="..\Images\Aladin 1.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Aladín MVP 370</div>
				</div>
			</div>

			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Aladin 3.jpg">
   						<img src="..\Images\Aladin 3.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Aladín MVP 460</div>
				</div>
			</div>
			...
			<div class="responsive">
  				<div class="gallery">
  					<a target="_blank" href="..\Images\Aladin 4.jpg">
   						<img src="..\Images\Aladin 4.jpg" alt="Cinque Terre" width="600" height="400">
  					</a>
  					<div class="desc">Aladín Alux 4</div>
				</div>
			</div>
