...
<html>
	...
	<body>
		<div class="contenedor">
			...
			<div class="cuerpo">
				...
				<table id="customers">
					...
					<tr>
						...
						<td></td>
						<td></td>
						<td>Importe final: <fmt:formatNumber maxIntegerDigits="4" value="${ptotal}"/> €</td>
						<td><input type="submit" value="Elimina"></td></td>
					</tr>
				</table>
				</form>
			</div>
			...
			<p class="referencia">
				<button><a HREF="Tienda.jsp">Sigo comprando</a></button> 
				<button><a HREF="Pago.jsp">Pagar</a></button>
			</p>
