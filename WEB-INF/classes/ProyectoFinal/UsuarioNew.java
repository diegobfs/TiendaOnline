...
public class UsuarioNew extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Comprobamos si existe el usuario registrado
        if (bd.acierto (nombre, contrasena) != false){
            // Presentamos los datos
		    gotoPage("/VistaRegistro.jsp", request, response);
        } else {
            gotoPage("/VistaRegistroMal.jsp", request, response);
        }
