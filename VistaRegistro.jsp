...
<body>
	<div class="contenedor">
			...
			<div class="navegador">
				<ul id="menu">
					...
					<li><a href="VistaRegistro.jsp"><strong>Hola, ${nombre}</strong></a></li>
				</ul>
			</div>
			</nav>
	...
	<!-- Inicio de sesión -->
		<div class = "cuerpo">
			<p style="font-size: 30px;">Bienvenido a Shisa Prime</p>
			<p style="font-size: 30px;"><strong>${nombre}</strong></p>
			<button><a href="InicioSesion.html">Cerrar sesión</a></button>
